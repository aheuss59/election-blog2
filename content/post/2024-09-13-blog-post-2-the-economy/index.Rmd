...
incumbent_econ_data |> 
  ...
  labs(x = "Q2 GDP Growth (%)", 
       ...
       color = "", 
       title = "Relationship Between Q2 GDP Growth and Incumbent Two-Party Popular Vote Share") + 
  theme_bw() + 
...
```{r, correlations between econ vars, echo=FALSE, message=FALSE}
...
```{r, national vote GDP only, echo=FALSE, message= FALSE}
GDP_new <- fred_data |> 
